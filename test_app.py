...
class OnlineJudgeTestCase(unittest.TestCase):
    ...
    def test_create_user(self):
        ...
        self.client().delete('/users/' + str(data['user_id']), headers = self.admin)
    ...
    def test_admin_can_delete_user(self):
        ...
        res = self.client().delete('/users/' + str(data['user_id']), headers = self.admin)
        data = json.loads(res.data)
    ...
    def test_admin_can_update_user(self):
        ...
        res = self.client().patch('/users/' + str(user_id), json=new_user, headers = self.admin)
        data = json.loads(res.data)
    ...
    def test_contestant_cannot_update_user(self):
        ...
        res = self.client().patch('/users/' + str(user_id), json=new_user, headers = self.contestant)
        data = json.loads(res.data)
    ...
    def test_admin_can_update_contest(self):
        ...
        res = self.client().patch('/contests/' + str(contest_id), json=new_contest, headers = self.admin)
        data = json.loads(res.data)
        self.client().delete('/contests/' + str(contest_id), headers = self.admin)
    ...
    def test_contestant_cannot_update_contest(self):
        ...
        res = self.client().patch('/contests/' + str(contest_id), json=new_contest, headers = self.contestant)
        self.client().delete('/contests/' + str(contest_id), headers = self.admin)
    ...
    def test_contestant_cannot_delete_contest(self):
        ...
        res = self.client().delete('/contests/' + str(contest_id), headers = self.contestant) 
        self.client().delete('/contests/' + str(contest_id), headers = self.admin) 
    ...
    def test_contestant_cannot_delete_problem(self):
        ...
        res = self.client().delete('/problems/' + str(problem_id), headers = self.contestant)
        data = json.loads(res.data)
        self.client().delete('/contests/' + str(contest_id), headers = self.admin)
    ...
    def test_create_submission(self):
        ...
        res = self.client().post('/submissions', json=new_submission, headers = self.contestant)
        data = json.loads(res.data)
    ...
    def test_create_participation(self):
        ...
        res = self.client().post('/participate', json=new_paticipation, headers = self.contestant)
        data = json.loads(res.data)
